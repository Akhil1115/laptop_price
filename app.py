...
Company = st.selectbox("Company", ['Apple', 'HP', 'Acer', 'Asus', 'Dell', 'Lenovo', 'Chuwi', 'MSI',
       ...
       'Mediacom', 'Samsung', 'Google', 'Fujitsu', 'LG'])  # use categories from your training set
Typename = st.selectbox("Typename", ['Ultrabook', 'Notebook', 'Gaming', '2 in 1 Convertible','Workstation', 'Netbook'])  # example
